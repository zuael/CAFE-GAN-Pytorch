...
def parse(args=None):
    ...
    parser.add_argument('--custom_data', type=str, default='path/to/data/custom')
    parser.add_argument('--custom_attr', type=str, default='path/to/data/list_attr_custom.txt')
